 ...
 */
class RoundTextView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (isCircle) {
            ...
            val rectF = RectF(strokeWidth / 2, strokeWidth / 2, measuredWidth - strokeWidth / 2, measuredHeight - strokeWidth / 2)
