        ...
        if (getItemCount() != 0 && mItemCount != 0) {
            ...
            if (mOrientation == HORIZONTAL) {
                ...
                if (mode == View.MeasureSpec.EXACTLY) {
                    setMeasuredDimension(mItemViewWidth * mItemCount, View.MeasureSpec.getSize(heightSpec));
                } else {
                ...
                final int mode = View.MeasureSpec.getMode(widthSpec);
                if (mode == View.MeasureSpec.EXACTLY) {
                    setMeasuredDimension(View.MeasureSpec.getSize(widthSpec), mItemViewHeight * mItemCount);
                } else {
