...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public static class Builder {
        ...
        public Builder(Context context, int defStyleRes, boolean isInEditMode) {
            this(context, null, 0, defStyleRes, isInEditMode);
        }

        public Builder(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, boolean isInEditMode) {
            ...
            strokeSize(a.getDimensionPixelSize(R.styleable.CircularProgressDrawable_cpd_strokeSize, isInEditMode ? 8 : dp2px(context, 4.0f)));
