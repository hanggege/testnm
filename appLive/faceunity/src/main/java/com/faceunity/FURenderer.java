...
public class FURenderer implements OnFUControlListener {
    ...
    private volatile static float mToothWhiten = 0.5f;//美牙
    ...
    private volatile static float mFilterLevel = 0.7f;//滤镜强度
    private volatile static float mSkinDetect = 1.5f;//肤色检测开关
    ...
    private volatile static float mFaceShapeLevel = 0.5f;//程度
    private volatile static float mCheekThinning = 0f;//瘦脸
    private volatile static float mCheekV = 0.5f;//V脸
    private volatile static float mCheekNarrow = 0.0f;//窄脸
    private volatile static float mCheekSmall = 0.0f;//小脸
