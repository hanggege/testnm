...
import com.mei.chat.recoder.control.uistate.PopWindowStateControl
...
@Suppress("unused")
fun TextView.recordAudio(start: () -> Unit = {},
                         finish: (File?, Int) -> Unit = { _, _ -> }) {
    RecordManager(this, object : OnRecordListener {
...
class RecordManager constructor(private val mTextView: TextView, private val mOnRecordListener: OnRecordListener) : View.OnTouchListener {

    private val mRecordControl: IRecordControl by lazy { MediaRecordControl(MyRecordControlListener()) }
    private val mStateControl: IUIStateControl by lazy { PopWindowStateControl(mTextView) }
