...
public abstract class BeautyParameterModel {
    ...
    public volatile static Map<String, Float> sFilterLevel = new HashMap<>(16);
    public volatile static Filter sFilter = FilterEnum.fennen.filter();
    public static float[] sHairLevel = new float[14];
    public volatile static float sSkinDetect = 1.0f;//精准磨皮
    public volatile static float sBlurType = 0; // 磨皮类型
    public static Map<Integer, Float> sBlurTypeLevels = new HashMap<>(4); // 三种磨皮程度
    public volatile static float sColorLevel = 0.3f;//美白
    public volatile static float sRedLevel = 0.3f;//红润
    public volatile static float sEyeBright = 0.0f;//亮眼
    public volatile static float sToothWhiten = 0.0f;//美牙
    public static volatile float sCheekThinning = 0f;//瘦脸
    public static volatile float sCheekV = 0.5f;//V脸
    public static volatile float sCheekNarrow = 0f;//窄脸
    public static volatile float sCheekSmall = 0f;//小脸
    public static volatile float sEyeEnlarging = 0.4f;//大眼
    public static volatile float sIntensityChin = 0.3f;//下巴
    public static volatile float sIntensityForehead = 0.3f;//额头
    public static volatile float sIntensityNose = 0.5f;//瘦鼻
    public static volatile float sIntensityMouth = 0.4f;//嘴形
    ...
    public static boolean checkIfFaceSkinChanged() {
        float i = FACE_SKIN_DEFAULT_PARAMS.get(R.id.beauty_box_skin_detect);
        if (Float.compare(sSkinDetect, i) != 0) {
            return true;
        }
    ...
    public static void recoverFaceShapeToDefValue() {
        FaceUnityKt.getCacheFaceShapeParams().clear();
    ...
    public static void recoverFaceSkinToDefValue() {
        FaceUnityKt.getCacheFaceSkinParams().clear();
