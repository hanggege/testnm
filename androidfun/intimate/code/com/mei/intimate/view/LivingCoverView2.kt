 ...
 * 直播tab条目动效
 */
class LivingCoverView2 @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0)
...
//            R.drawable.live_heart_blue, R.drawable.live_heart_purple)
    private val resIds = arrayListOf(R.drawable.live_heart_red_new, R.drawable.live_heart_red_new_two, R.drawable.live_heart_red_new, R.drawable.live_heart_red_new_two)
...
//        addView(bottomView)
    ...
    private val runnable = object : Runnable {
        override fun run() {
            ...
            val intervalTime = Random().nextInt(1500)
    ...
    private fun startAnimator(target: ImageView) {
        ...
        val besselAnimator = ValueAnimator.ofObject(evaluator, point0, point3).setDuration(5000)
        ...
        besselAnimator.addUpdateListener { animation ->
            ...
            target.scaleX = 0.2f + 1.8f * fraction
            target.scaleY = 0.2f + 1.8f * fraction
            if (fraction > 0.2f) {
