...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mSelectBackgroundColor = ta.getColor(R.styleable.SlidingTabLayout_tl_background_selectColor, Color.TRANSPARENT);
        mUnSelectBackgroundColor = ta.getColor(R.styleable.SlidingTabLayout_tl_background_unSelectColor, Color.TRANSPARENT);
        mTabRadius = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_radius, 0);
        ta.recycle();
    }
